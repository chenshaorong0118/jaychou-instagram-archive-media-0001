# Jay Chou Instagram Archive — Media Shard

> 非官方公开归档媒体分库 / Unofficial public archive media shard

本仓库保存已验证的公开归档媒体与条目级元数据。总索引与视觉时间线位于主索引仓库。
...
使用媒体前请阅读 [MEDIA_RIGHTS.md](MEDIA_RIGHTS.md)。代码许可不覆盖归档媒体。
